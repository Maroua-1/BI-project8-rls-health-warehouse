...
-- ROLES POSTGRESQL
DO DROP SCHEMA public CASCADE; CREATE SCHEMA public;
BEGIN
...
GRANT INSERT, UPDATE ON faits_consultation, faits_prescription, faits_acte_realise TO role_medecin;
GRANT USAGE ON ALL SEQUENCES IN SCHEMA public TO role_medecin;

-- FONCTIONS MASQUAGE
CREATE OR REPLACE FUNCTION masquer_cin(cin_original TEXT)
RETURNS TEXT LANGUAGE plpgsql SECURITY DEFINER AS DROP SCHEMA public CASCADE; CREATE SCHEMA public;
BEGIN
...
DO DROP SCHEMA public CASCADE; CREATE SCHEMA public; BEGIN
  RAISE NOTICE 'Schema cree avec succes - Hopital Ibn Sina Rabat';
END DROP SCHEMA public CASCADE; CREATE SCHEMA public;;
